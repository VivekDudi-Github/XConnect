...
const handleEmojiSelect = (emoji) => {
  ...
  return (
    <div className="max-w-2xl max-h-screen pb-16 sm:pb-0 mx-auto mt-10 bg-zinc-100 dark:bg-[#161b22] dark:text-white p-6 rounded-xl border border-gray-700 shadow-lg relative">
